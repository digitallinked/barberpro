...
/** Read-only hours block — matches the edit panel list styling */
...
export default function BranchDetailPage() {
  ...
  // ── Derived display values (server data — always in sync after refetch) ───────
  ...
  return (
    <>
      <div className="divide-y divide-white/5">
        ...
        {/* ── Operation Hours (same layout as edit panel) ───────────────────────────────── */}
        <div className="p-6">
