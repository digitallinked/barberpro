...
export function CookieConsentBanner() {
  ...
  return (
    <div
      ...
      aria-live="polite"
      className="fixed bottom-[calc(4.5rem+env(safe-area-inset-bottom))] left-0 right-0 z-50 px-4 pb-2 lg:bottom-0 lg:pb-0"
    >
      <div className="mx-auto max-w-5xl rounded-2xl border border-[#D4AF37]/20 bg-[#111111]/95 p-4 shadow-2xl shadow-black/60 backdrop-blur-md lg:mb-4 lg:flex lg:items-center lg:gap-6 lg:rounded-2xl lg:p-5">
