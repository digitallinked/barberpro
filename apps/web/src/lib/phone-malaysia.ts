/**
 * Normalize Malaysian mobile numbers toward E.164-style +60… for storage and deduping.
 * Handles common variants: +60162290742, 60162290742, 0162290742, 01-62290742, etc.
 */
...
/** Values to try when matching an existing customer row (legacy rows may use different formatting). */
